...
let me = {
  name: 'your name', // values need to be 'strings' if they are text.
  age: 'your age',
};
...
let favoriteThings = {
  band: 'Dunno',
  food: 'Probably Metsican',
  person: 'Kazoo Kid or Donovan Clogginson',
  book: 'The Stormlight Archives',
  movie: 'Hot Fuzz',
  holiday: 'National Kazoo Day',
};
...
favoriteThings.car = 'HotWheels'; //dot notation to add key-value pair

favoriteThings["brand"] = 'HotWheel Brand'; //bracket notation to add key-value pair
...
backPack[item] = 'chapstick'; //creating key-value pair with a variable

backPack.color = 'arnge';
...
user2['email'] = 'bryan.smith@devmounta.in'; /// it worked!
